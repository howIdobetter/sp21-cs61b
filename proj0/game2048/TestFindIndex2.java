...
public class TestFindIndex2 {
    ...
    public void test2() {
        ...
        Board b = new Board(board, 0);
        int[] num0 =  Model.findIndex2(0, b);
        int[] result0 = new int[] {1, 3};
        Assert.assertArrayEquals(result0, num0);
        int[] num1 =  Model.findIndex2(1, b);
        int [] result1 = new int[] {0, 2};
        Assert.assertArrayEquals(result1, num1);
        int[] num2 =  Model.findIndex2(2, b);
        int[] result2 = new int[] {1, 2};
        Assert.assertArrayEquals(result2, num2);
        int[] num3 =   Model.findIndex2(3, b);
